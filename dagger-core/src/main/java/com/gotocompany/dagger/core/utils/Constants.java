...
public class Constants {
    ...
    public static final String PROCESSOR_LONGBOW_STORAGE_TYPE = "PROCESSOR_LONGBOW_STORAGE_TYPE";
    ...
    public static final String PROCESSOR_LONGBOW_TABLESTORE_CLIENT_INSTANCE_NAME = "PROCESSOR_LONGBOW_TABLESTORE_CLIENT_INSTANCE_NAME";
    public static final String PROCESSOR_LONGBOW_TABLESTORE_CLIENT_ACCESS_KEY_ID = "PROCESSOR_LONGBOW_TABLESTORE_CLIENT_ACCESS_KEY_ID";
    public static final String PROCESSOR_LONGBOW_TABLESTORE_CLIENT_ACCESS_KEY_SECRET = "PROCESSOR_LONGBOW_TABLESTORE_CLIENT_ACCESS_KEY_SECRET";
    public static final String PROCESSOR_LONGBOW_TABLESTORE_CLIENT_ENDPOINT = "PROCESSOR_LONGBOW_TABLESTORE_CLIENT_ENDPOINT";
    public static final String PROCESSOR_LONGBOW_TABLESTORE_TABLE_ID = "PROCESSOR_LONGBOW_TABLESTORE_TABLE_ID";
    public static final String PROCESSOR_LONGBOW_TABLESTORE_PRIMARY_KEY_NAME = "PROCESSOR_LONGBOW_TABLESTORE_PRIMARY_KEY_NAME";
    public static final String PROCESSOR_LONGBOW_TABLESTORE_COLUMN_FAMILY_NAME = "PROCESSOR_LONGBOW_TABLESTORE_COLUMN_FAMILY_NAME";
