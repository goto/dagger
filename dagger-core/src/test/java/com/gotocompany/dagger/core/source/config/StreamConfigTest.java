...
public class StreamConfigTest {
    ...
    public void shouldParseKafkaPropertiesWithSSLConfigurations() {
        ...
        kafkaPropMap.put("ssl.keystore.type", "test-keystore-type");
        ...
        kafkaPropMap.put("ssl.truststore.type", "test-truststore-type");
    ...
    public void shouldParseMultipleStreamsFromStreamConfigWithSSLConfigurations() {
        ...
        assertEquals("test-keystore-type", currConfig.getSslKeystoreType());
        ...
        assertEquals("test-truststore-type", currConfig.getSslTruststoreType());
